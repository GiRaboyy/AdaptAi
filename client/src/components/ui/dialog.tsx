  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "bg-white/80 dark:bg-slate-900/80 backdrop-blur-[14px] border border-foreground/10 shadow-[0_24px_60px_rgba(7,16,36,0.16)]",
        className
      )}
      {...props}
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-xl p-1.5 opacity-70 ring-offset-background transition-all hover:opacity-100 hover:bg-foreground/5 focus:outline-none focus:ring-4 focus:ring-primary/20 disabled:pointer-events-none">
        <X className="h-4 w-4" />
