      ...
      <main>
        <section className="py-24 md:py-32 px-6">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <Link href="/auth?role=curator">
                <Button 
                  className="rounded-2xl font-bold text-[28px] px-[60px] py-[48px]"
            ...
            >
              <div className="bg-card rounded-3xl shadow-lg border border-border overflow-hidden">
                ...
                <div className="flex">
                  <div className="w-64 bg-card border-r border-border p-5">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-3 p-3 rounded-xl bg-primary/10 border border-primary/40">
                  ...
                  <div className="flex-1 p-6 bg-muted">
                    ...
                    <div className="bg-card rounded-2xl border border-border p-5 mb-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3 p-3 rounded-xl border border-primary/50 bg-primary/10 text-sm">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <button className="w-10 h-10 rounded-xl bg-card border border-border flex items-center justify-center text-foreground">
        ...
        <section className="py-6 px-6 border-y border-border bg-muted">
          <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-center gap-8 md:gap-12">
            ...
            <Link href="/auth?role=curator">
              <button 
                className="bg-card hover-elevate transition-all duration-200 text-foreground border border-border py-5 px-12 rounded-xl text-xl font-bold flex items-center gap-3"
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={step.num} className="text-center p-8 rounded-3xl bg-card border border-border">
        ...
        <section className="py-24 px-6 bg-muted">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-12 max-w-lg mx-auto font-medium">
              Создайте первый курс бесплатно и оцените возможности платформы
            </p>
            <Link href="/auth?role=curator">
              <Button 
                variant="secondary"
                className="h-[80px] px-16 rounded-2xl text-2xl font-bold"
