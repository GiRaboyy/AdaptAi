...
export const knowledgeSources = pgTable("knowledge_sources", {
  ...
  extractionStatus: text("extraction_status", { enum: ["pending", "ok", "no_text", "failed"] }).notNull().default("pending"),
  extractionError: text("extraction_error"),
  extractedTextChars: integer("extracted_text_chars").notNull().default(0),
